...
**Reason**: El préstamo siempre se crea desde el contexto de un cliente ya existente. Si el cliente no existe, debe crearse primero en Gestión de Clientes.
**Migration**: Crear el cliente en `/clientes` antes de registrar el préstamo.
