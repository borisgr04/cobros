# mobile-user-menu-access

## Purpose

Enable mobile users to access the user query/consultation feature directly from the bottom navigation menu, providing feature parity with desktop users.
