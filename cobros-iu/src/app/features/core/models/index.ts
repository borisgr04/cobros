...
export type { ICliente, IClienteConPrestamosActivos, IPrestamoConPagos, IClienteConPrestamos } from './cliente.model';
export type { IZona } from './zona.model';
export type { IPrestamo } from './prestamo.model';
export type { IPago } from './pago.model';
export type { INovedadPrestamo, IProntoPagoResumen, IProntoPagoResultado, IAmpliacionPlazoResumen, IAmpliacionPlazoInput, IAmpliacionPlazoResultado, IRecogerPrestamoInput, IRecogerPrestamoResultado } from './novedad-prestamo.model';
